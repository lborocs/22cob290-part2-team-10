...
import type { ResponseSchema as GetProjectResponse } from '~/pages/api/projects/getAssignedProjects';
...
export default function ProjectsList() {
  ...
  useEffect(() => {
    ...
    axios.get<GetProjectResponse>('/api/projects/getAssignedProjects', { signal })
