...
<body>
  <div id="commentEditor" class="modal fade" tabindex="-1" aria-labelledby="commentEditor">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form onsubmit="addPost(this, event)">
            ...
            <input type="text" class="textField" id="postTopicsText" placeholder="Enter a topic" onkeyup="addTagToPost()">
      ...
      <div class="container">
        <div id="leftMain" class="container-fluid">
          <div class="row centeredDiv">
              <input id="searchField" type="search" class="darkGrey textField" placeholder="Search By Title..." onsearch="get_comments()">
          </div>
          ...
          <div class="row centeredDiv">
              <button id="newPost" type="button" class="mb-3" data-bs-toggle="modal" data-bs-target="#commentEditor">
