...
const active_employees: Employee[] = [
  {
    name: "John Gatsby",
    role: "Team Member",
  },
...
function get_roles_as_select_menu(selected_role: Role) {
  let str = "";
...
function add_employee(eName: string, eRole: Role) {
...
$('#add_employee_btn').on('click', function (e) {
  ...
  const eRole = $("#roles :selected").text()! as Role;
